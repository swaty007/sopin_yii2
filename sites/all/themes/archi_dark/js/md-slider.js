...
(function ($) {
    ...
    $.fn.mdSlider = function (options) {
        ...
        function resizeWindow() {
            ...
            {
                //$(".md-objects", self).width($(window).width());
                //$(".md-objects", self).height($(window).height());
                $(".md-slide-item", self).height($(window).height());
        ...
        function changeImagePosition($background, width, height) {
            ...
            if(height > 0 && panelHeight > 0) {
                if (((width / height) > (panelWidth / panelHeight))) {
                    ...
                    $background.css({width: panelWidth + "px", height:panelWidth/2 +"px"});
                    if(top < 0) {
